...
class UI_Kit {
   public:
    ...
    void runningWrite(void) {
        ...
        // coordinate
        uartPtr->write(highByte(location.coordinateX));
        uartPtr->write(lowByte(location.coordinateX));

        uartPtr->write(highByte(location.coordinateY));
        uartPtr->write(lowByte(location.coordinateY));
